...
const LoginList = () => {
  ...
  const [setToken, setRole, setLogged, is_logged] = usePersistedAdmin((state) => [
    state.setToken,
    state.setRole,
    state.setLogged,
    state.is_logged,
        ...
        <div className="mx-auto grid w-[400px] gap-6">
          ...
          <div className="p-5 bg-white shadow-sm ring-1 ring-gray-900/5 md:rounded-lg">
            <div className="grid gap-2 text-center">
              <h1 className="text-3xl font-bold pb-3">Login Admin</h1>
              <p className="text-balance text-muted-foreground text-sm opacity-75">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input id="email" {...field} type="email" placeholder="john@mail.com" required />
                        </FormControl>
                        <FormDescription>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input id="password" {...field} type="password" placeholder="enter your password" required />
                        </FormControl>
                        <FormDescription>
