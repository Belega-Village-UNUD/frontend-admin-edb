...
const NewFee = () => {
  ...
  const handleCreateNewFee: SubmitHandler<FieldValues> = useCallback(
    async (data) => {
      try {
      ...
      <div className="lg:-mx-8 lg:mb-4 text-sm text-gray-400 breadcrumbs">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href={"/Dashboard/fee"}>All Fee</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
            ...
            <div className="md:p-6 bg-white shadow-sm ring-1 ring-gray-900/5 md:rounded-lg">
              ...
              <div className="space-y-12 sm:space-y-16">
                ...
                <div className="flex items-center justify-end gap-x-6">
                  ...
                  >
                    <Link href="/Dashboard/fee">Cancel</Link>
                  </button>
                  <button
                    type="submit"
