...
import { ArrowUpDown, Filter, MoreHorizontal, PencilIcon, Search } from "lucide-react"
  ...
  const handleGetAllStore = useCallback(async () => {
    try {
      ...
      if (responseJson.success === true) {
        const verifiedStores = responseJson.data.filter((store) => store.is_verified === 'DECLINED');
    ...
    <div className="w-full">
      <div className="lg:-mx-8 lg:mb-4 lg:px-8 text-sm text-gray-400 breadcrumbs">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage className="font-semibold">Declined Store</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <div className="lg:px-8 lg:mb-2 sm:flex sm:items-center">
        <div className="lg:-mx-8 sm:flex-auto">
          <h1 className="flex-1 text-2xl font-bold text-gray-900">Declined Store</h1>
          <p className="text-sm text-gray-500">
            List of all declined store.
          </p>
        </div>
      </div>
