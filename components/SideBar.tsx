...
import UserStore from "@/components/nav/UserStore";
import {
  Dialog,
  Disclosure,
  DisclosureButton,
...
const SideBar: React.FC<navigationType> = ({ main }) => {
  ...
  const navigation = [
    { name: "Dashboard", href: "/Dashboard", icon: HomeModernIcon },
    {
      ...
      icon: StoreIcon,
      children: [
        { name: "List Store", href: "/Dashboard/store" },
        { name: "Confirmation Store", href: "/Dashboard/store/confirm" },
        { name: "Declined Store", href: "/Dashboard/store/cancel" },
      ],
    },
    {
      name: "Fee",
      ...
      icon: ShoppingBag,
      children: [
        { name: "List Fee", href: "/Dashboard/fee" },
        { name: "Create New Fee", href: "/Dashboard/fee/new" },
      ],
    },
    {
      name: "Transaction",
      ...
      children: [
        { name: "List Transaction", href: "/Dashboard/transaction" },
        { name: "Cancellation", href: "/Dashboard/transaction/cancel" },
      ],
    },
    {
      name: "Payout",
      href: "#",
      icon: HandCoins,
      children: [{ name: "List Payout", href: "/Dashboard/payout" }],
    },
    // {
    //   name: "Store",
    //   href: "#",
